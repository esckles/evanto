...
import pix1 from "./assets/pics/set102.jpg";
import pix2 from "./assets/pics/set10i.jpg";
import pix3 from "./assets/pics/setNext.jpg";
import pix4 from "./assets/pics/part.jpg";
import {
  animate,
  AnimatePresence,
  motion,
